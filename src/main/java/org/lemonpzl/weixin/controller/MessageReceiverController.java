package org.lemonpzl.weixin.controller;
...
import org.lemonpzl.weixin.service.MessageTypeMapper;
...
@RequestMapping("/pzl/weixin/receiver")
public class MessageReceiverController {
	...
	public String onMessage(@RequestParam("signature") String signature, //
	    ...
	    inMessageTemplate.convertAndSend("pzl_" + inMessage.getMsgType(), inMessage);
...
//
//					String channel = "pzl_" + inMessage.getMsgType();
//
//					// 消息内容要自己序列化才能放入队列中
